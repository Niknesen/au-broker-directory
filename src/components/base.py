...
{CSS_STYLES}
  ...
  <!-- High Performance Telemetry Loader (Zero Main-Thread Blocking) -->
  <script>
  ...
  function initTelemetry() {{
    ...
    ga.async = true;
    ga.src = 'https://www.googletagmanager.com/gtag/js?id=G-KVR945JRS2';
  ...
  if ('requestIdleCallback' in window) {{
    requestIdleCallback(initTelemetry, {{ timeout: 1500 }});
  }} else {{
